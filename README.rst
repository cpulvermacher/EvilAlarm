...
* Normal (default): A well-behaved alarm that has a "Stop" button to turn it off.
* Blubbels: A small game that will momentarily pause the alarm while you play.
	Requires you too reach a configurable number of points to turn it off.
* Movement: Moving the phone will silence the alarm for a short while, the alarm
